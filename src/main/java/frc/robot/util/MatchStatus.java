...
public class MatchStatus {
  ...
  // You can use Timer.getMatchTime(), which would give you an APPROXIMATE time remaining
  // (countdown)
  ...
  public static Hubs getActiveHub() {
    if (getCurrentShift() == GameStates.AUTO
        || getCurrentShift() == GameStates.TRANSITION
        || getCurrentShift() == GameStates.END_GAME) {
      return Hubs.BOTH;
