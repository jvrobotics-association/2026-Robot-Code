...
public final class Constants {
  ...
  public final class IntakeConstants {
    ...
    public static final double PID_KS = 0.0;
    public static final double PID_KV = 0.0;
    public static final double PID_KA = 0.0; // not used
    public static final double PID_KP = 0.0;
  ...
  public final class ShooterPitchConstants {
    ...
    public static final double MM_ACCELERATION = 360.0;
    public static final double MM_CRUISE_VEL = 90.0;
    public static final double MM_JERK = 0.0; // not used
    public static final double PID_KS = 0.22;
    public static final double PID_KV = 0.1;
    public static final double PID_KA = 0.0; // not used
    public static final double PID_KP = 0.8;
    public static final double PID_KI = 0.0; // not used
  ...
  public final class IntakeExtensionConstants {
    ...
    public static final double SENSOR_TO_MECH_RATIO = 0;
